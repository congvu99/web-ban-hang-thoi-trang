...
<head>
	...
	<meta http-equiv="refresh" content="3;url=<?php echo base_url();?>index.php/Admin_controller/">
...
<body>
	<div class="container ">
		<div class="alert alert-success text-sm-center mt-4">Cập Nhập Thành Công Tài Khoản! </div>
	</div>
</body>
</html>