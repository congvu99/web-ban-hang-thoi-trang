...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>/Vendor/sanpham.css">
 ...
 <!--  phần phân trang -->
  ...
  <div class="container mt-3">
    <nav aria-label="Page navigation example">
      <ul class="pagination">
      <li class="page-item">
        <a class="page-link" href="<?php echo base_url() ?>index.php/Homepage/back/" aria-label="Previous">
      ...
      {
      ?>
        <li class="page-item"><a class="page-link" href="<?php echo base_url() ?>index.php/Homepage/page/<?= $i ?>"><?= $i+1 ?></a></li>
      <?php 
      }
       ?>
        
      <li class="page-item">
        <a class="page-link" href="<?php echo base_url() ?>index.php/Homepage/next/" aria-label="Next">
